...
var cities = ["Piatra Neamt", "Bacau", "Slanic Moldova", "Petrosani"];
...
var names= ["Costin","Miron","Alexandru","Gica","Alan"];
...
var text= "fserfes Dragos fesfe Dragos eibler";
var myName ="Dragos";
var hits= [];
...
while(condition){
    ...
    console.log("Apare propozitia asta");
...
var getToDaChoppa = function(){
  ...
  do{
      ...
      console.log("printeaza sirul meu");
      } while(getToDaChoppa);
...
switch(candy) {
  ...
  console.log("Don`t know my favourite candy");
...
switch(answer) {
  ...
  console.log("Da eu de unde sa stiu?");
...
// Write your code below!
var nume=prompt("Zi ma un nume,sa vad daca ghicesti!")
...
switch(nume){
    ...
    case 'Maria':
        console.log("Exact !Maria");
        break;
        
        case 'bembinut':
            
            console.log("de unde stii tu de bembinut?");
            break;
            
            case 'Mos Craciun':
                console.log("Bravo ma!");
                break;
                
                default:
                
                console.log("hai ca acum n-ai mai ghicit!");
